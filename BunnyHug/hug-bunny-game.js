function init() {  
  ...
  const triggerBunnyMessage = (bunny, classToAdd) => {
    bunny.el.setAttribute('message', ['Makasii!', 'arigato!', 'syukron!', '^ _ ^', 'thank you!', 'maturnuwun', 'kansahamida!', 'muachh!','loff uu!', 'maaciiw'][randomN(10) - 1])
  ...
  new Array(15).fill('').forEach(()=> addBunny())
  new Array(100).fill('').forEach(()=> addTree())
  updateSadBunnyCount()
}

document.getElementById('nextPageButton').addEventListener('click', function() {
  window.location.href = 'love.html'; // Ganti dengan nama file halaman selanjutnya
});
