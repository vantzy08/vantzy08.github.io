...
document.getElementById('verificationName').addEventListener('submit', function(e) {
    ...
    // Validasi nama
    const validNames = ['Zilda', 'zilda', 'Jieldaa', 'Zilda Khafka Navisa', 'Jieldutt'];
...
document.getElementById('verification').addEventListener('submit', function(e) {
    ...
    if (isPartner !== 'yes') {
        Swal.fire({
            title: 'Bukan Bestie Papann!',
            text: 'Ohh gituu, uda nemu yg lebih asik kah?, ckptw!.',
            icon: 'warning',
        }).then(() => {
    ...
    Swal.fire({
        ...
        text: 'Selamat menikmati Jieldaaa imupp!',
        icon: 'success',
    }).then(() => {
